...
validaChar("corJ", regexLETRAS, 1);
validaChar("anodefabricJ", regexDATA, 2);
validaChar("numeixosJ", regexNUMEROS, 3);
validaChar("pbtJ", regexNUMEROS, 4);
validaChar("modeloJ", regexLETRAS, 5);
validaChar("fabricanteJ", regexLETRAS, 6);
validaChar("rntrcJ", regexNUMEROS, 7);
