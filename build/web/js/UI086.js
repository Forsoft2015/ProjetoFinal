...
validaChar("tipoJ", regexLETRAS, 0);
validaChar("extensaokmJ", regexNUMEROS, 1);
validaChar("cinicialJ", regexLETRAS, 2);
validaChar("cfinalJ", regexLETRAS, 3);
validaChar("telJ", regexTEL, 4);
validaChar("numserieJ", regexNUMEROS, 5);
validaChar("descricaopostoJ", regexLETRAS, 6);
validaChar("kmJ", regexNUMEROS, 7);
