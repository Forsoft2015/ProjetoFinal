...
<head>
	...
	<script src="../js/UI118.js" defer></script>
	<script src="../js/framework.js" defer></script>
</head>
<body>

	<div id="topbar" class="conteudo-meio">
		<a href="UI152-Home-AdmANTT.jsp" id="logo" class="esquerda"><img src="../img/logoS2.png" alt="DigiMon"></a>
	...
	<div id="container" class="conteudo-meio">
		...
		<div id="centro" class="esquerda full">
			...
			<form id="formularioJ" action="#" method="post" class="formulario">
	           ...
	           <a href="UI152-Home-AdmANTT.jsp"><input type="button" value="Cancelar" name="Limpar" id="limparJ" class="botaoJ"></a>
			</form>
		</div>
