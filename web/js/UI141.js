...
//ValidaTipo(idDoCampo, regexTIPO, numeroDoCampo)
	...
	validaChar("dataJ", regexDATA, 4);
	validaChar("telJ", regexTEL, 5);
	validaChar("tel2J", regexTEL, 6);
	validaChar("celularJ", regexTEL, 7);
	validaChar("cnhJ", regexNUMEROS, 8);
	validaChar("rntrcJ", regexNUMEROS, 9);
	validaEmail("emailJ", regexEMAIL, 10);
	validaChar("logradouroJ", regexLETRAS, 11);
	validaChar("numeroJ", regexNUMEROS, 12);
	validaChar("complementoJ", regexLETRAS, 13);
	validaChar("cepJ", regexCEP, 14);	
	validaChar("bairroJ", regexLETRAS, 15);
	validaChar("cidadeJ", regexLETRAS, 16);
	validaChar("estadoJ", regexLETRAS, 17);
