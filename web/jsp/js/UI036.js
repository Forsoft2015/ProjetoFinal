...
//ValidaTipo(idDoCampo, regexTIPO, numeroDoCampo)
	...
	validaChar("logradourodestinoJ", regexLETRAS, 7);
	validaChar("numerodestinoJ", regexNUMEROS, 8);
	validaChar("complementodestinoJ", regexLETRAS, 9);
	validaChar("cepdestinoJ", regexCEP, 10);
	validaChar("bairrodestinoJ", regexLETRAS, 11);
	validaChar("cidadedestinoJ", regexLETRAS, 12);
	validaChar("estadodestinoJ", regexLETRAS, 13);
