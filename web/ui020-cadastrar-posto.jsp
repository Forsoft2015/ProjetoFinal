<%-- 
    Document   : ui020-cadastrar-posto
    Created on : 11/10/2015, 00:19:40
    Author     : Luiz
--%>
        ...
        <div id="interface">
            ...
            <div id="main">
                <div class="centro">
                    ...
                    <form name="form" method="post" action="ServletUI020" id="formularioJ" class="formulario">	
                        ...
                        <fieldset>
                            ...
                            <div class="campo"> 
                                ...
                                <input type="text" name="logradouro" id="logradouroJ" maxlength="40" class="campoObrig"><span id="x_logradouroJ" class="tSpan
                                                                                                                              "></span>
                            </div>
                            <div class="campo"> 
                            ...
                            <div class="campo"> 
                                ...
                                <input type="text" name="complemento" id="complementoJ" maxlength="10" class="campoObrig"><span id="x_complementoJ" class="tSpan"></span>
                            </div>
                            <div class="campo"> 
                                <label for="cepJ">CEP:</label> 
                                <input type="text" name="cep" id="cepJ" maxlength="10" class="campoObrig"><span id="x_cepJ" class="tSpan"></span>
                            </div>
                            <div class="campo"> 
